...
class Channelname(commands.Cog):
    ...
    async def changetextchannelname(self,interaction: discord.Interaction, channel: discord.TextChannel, new__name: str):
            await channel.edit(name=new__name)
            await interaction.response.send_message(f"已將頻道名稱更改為 {new__name}")
